...
// class DNA {
	...
	// Current song should be live updated with the GA
	// var genes = {
		// beats:[][],
		// tempo:0,			// [10,200]
		// beat_density:[],	// [0,100]
	...
	// calcFitnessInitial(target) {
		// fitness = 0;
		// fitness = fitness + Math.abs(genes.tempo-target.tempo)/200
		// for (var i = 0; i < instruments.length; i++) {
			// fitness = fitness + Math.abs(genes.beat_density[i] - target.beat_density[i])/100
		// }
	// }
	...
	// calcFitnessFull(target) {
		...
		// for (var i = 0; i < instruments.length; i++) {
			// fitness = fitness + Math.abs(genes.beat_density[i] - target.beat_density[i])/100
		// }
		// fitness = fitness + Math.abs(genes.pitch-target.pitch)/100
		// fitness = fitness + Math.abs(genes.attack-target.attack)/1
		// fitness = fitness + Math.abs(genes.delay-target.delay)/4
	// }
